...
import { GetAlert, UpdateAlert } from "@/services/alerts";
    ...
    async function updateAlert() {
        ...
        if (!result.has_error) {
            Alert.alert("Alert", "Alert updated succesfully", [
                {
                    text: "OK",
                    onPress: () => router.replace("/(app)/(tabs)/home/alerts/alert-list"),
                },
            ]);
        }
    }
